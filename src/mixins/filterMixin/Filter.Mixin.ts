...
import { cwarn } from '../../utils/helpers/helpers.js';
...
export function FilterMixin<TBase extends abstract new (...args: any[]) => any>(
  Base: TBase
) {
  abstract class Filterable extends Base {
  ...
  /*
  return Filterable as unknown as abstract new (
    ...args: ConstructorParameters<TBase>
  ) => InstanceType<TBase> & Filterable;
	*/
}
