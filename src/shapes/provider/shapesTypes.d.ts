export type iShape = InstanceType<
  typeof import('./../graphicsEntity/graphicsEntity').GraphicsEntity
>;
...
export type iCurve = InstanceType<typeof import('./shapes').Curve>;
export type iCubicCurve = InstanceType<typeof import('./shapes').CubicCurve>;
export type iArcCurve = InstanceType<typeof import('./shapes').ArcCurve>;
export type iEarcCurve = InstanceType<typeof import('./shapes').EarcCurve>;
export type iQuadraticCurve = InstanceType<
  typeof import('./shapes').QuadraticCurve
>;
